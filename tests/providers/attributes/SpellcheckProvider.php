...
/**
 * Data provider for {@see \yii\ui\tests\attributes\HasSpellcheckTest} class.
 *
 ...
 * supporting both explicit `bool`, `string` values, and `null` for attribute removal, to maintain consistent output
 ...
 * - Validation of `bool`, `string`, and `null` values for the `spellcheck` attribute, including replacement and unset
 *   scenarios.
 *
...
final class SpellcheckProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `spellcheck` attribute
     * value, including `bool`, `string`, and replacement scenarios.
     *
