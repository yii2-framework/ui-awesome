 ...
 * - Validation of `string` (including empty strings) and `null` values for the `itemprop` attribute.
 *
...
final class ItemPropProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `itemprop` attribute
     * value, including empty `string` values, `null`, and standard string values.
     *
