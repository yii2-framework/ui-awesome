...
/**
 * Data provider for {@see \yii\ui\tests\attributes\HasTabIndexTest} class.
 *
 ...
 * both explicit `int` and `string` values, as well as `null` for attribute removal, to maintain consistent output
 ...
 * - Validation of `int`, `string` (including empty strings), and `null` values for the `tabindex` attribute.
 *
...
final class TabIndexProvider
{
     ...
     * including `int`, `string`, and `null` values, as well as replacement and unset scenarios.
     *
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `tabindex` attribute
     * value, including `int`, `string`, and `null` values, as well as replacement and unset scenarios.
     *
