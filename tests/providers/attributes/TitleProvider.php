 ...
 * explicit `string` values, `UnitEnum` for enum-based values, and `null` for attribute removal, to maintain consistent
 ...
 * - Validation of empty `string`, `UnitEnum` and `null` values for the `title` attribute.
 *
