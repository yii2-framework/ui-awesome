...
/**
 * Data provider for {@see \yii\ui\tests\attributes\CanBeHiddenTest} class.
 *
 ...
 * both explicit `bool` values and attribute replacement, to maintain consistent output across different rendering
 * configurations.
 *
 ...
 * - Validation of `bool` values for the `hidden` attribute, including replacement and unset scenarios.
 *
...
final class HiddenProvider
{
     ...
     * including `bool` values and replacement scenarios.
     *
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `hidden` attribute value,
     * including `bool` values and replacement scenarios.
     *
