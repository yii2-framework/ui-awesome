 ...
 * - Validation of `string` (including empty strings) and `null` values for the `itemid` attribute.
 *
...
final class ItemIdProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `itemid` attribute value,
     * including empty `string` values and `null` for attribute removal.
     *
