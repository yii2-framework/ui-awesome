 ...
 * both explicit `bool` values and `null` for attribute removal, to maintain consistent output across different
 ...
 * - Validation of `bool` and `null` values for the `itemscope` attribute.
 *
...
final class ItemScopeProvider
{
     ...
     * including `bool` values and `null` for attribute removal.
     *
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `itemscope` attribute
     * value, including `bool` values and `null` for attribute removal.
     *
