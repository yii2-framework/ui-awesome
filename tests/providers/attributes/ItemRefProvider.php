 ...
 * - Validation of `string` (including empty strings) and `null` values for the `itemref` attribute.
 *
...
final class ItemRefProvider
{
     ...
     * including empty `string` values, `null`, and standard string values.
     *
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `itemref` attribute value,
     * including empty `string` values, `null`, and standard string values.
     *
