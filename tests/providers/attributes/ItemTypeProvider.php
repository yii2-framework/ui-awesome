 ...
 * `string` values and `null` for attribute removal, to maintain consistent output across different rendering
 * configurations.
 *
 ...
 * - Validation of `string` (including empty strings) and `null` values for the `itemtype` attribute.
 *
...
final class ItemTypeProvider
{
     ...
     * including empty `string` values and `null` for attribute removal.
     *
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `itemtype` attribute
     * value, including empty `string` values and `null` for attribute removal.
     *
