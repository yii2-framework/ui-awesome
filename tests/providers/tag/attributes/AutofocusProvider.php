 ...
 * explicit `bool` values and attribute replacement, to maintain consistent output across different rendering
 * configurations.
 *
 ...
 * - Validation of `bool` values for the `autofocus` attribute, including replacement and unset scenarios.
 *
...
final class AutofocusProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `autofocus` attribute
     * value, including `bool` values and replacement scenarios.
     *
