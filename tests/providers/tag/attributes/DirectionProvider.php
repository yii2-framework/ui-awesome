 ...
 * explicit `string` values, `UnitEnum` for enum-based direction values, and `null` for attribute removal, to maintain
 ...
 * - Validation of `string` (including empty strings), `UnitEnum` instances, and `null` values for the `dir` attribute.
 *
...
final class DirectionProvider
{
     ...
     * `string` values, `UnitEnum` instances, and replacement scenarios.
     *
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the global HTML `dir` attribute value,
     * including `string` values, `UnitEnum` instances, and replacement scenarios.
     *
