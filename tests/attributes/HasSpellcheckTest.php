...
use yii\ui\attributes\HasSpellcheck;
use yii\ui\exception\Message;
use yii\ui\helpers\Attributes;
use yii\ui\mixin\HasAttributes;
use yii\ui\tests\providers\attributes\SpellcheckProvider;
 ...
 * `bool`, `string`, and `null` values for dynamic spellcheck state assignment.
 *
 * Test coverage:
 ...
 * - Proper assignment and overriding of `spellcheck` values.
 *
