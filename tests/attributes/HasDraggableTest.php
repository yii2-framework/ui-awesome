...
use UnitEnum;
use yii\ui\attributes\HasDraggable;
 ...
 * `bool`, `string`, `UnitEnum`, and `null` values for dynamic draggable state assignment.
 *
 * Test coverage:
 ...
 * - Proper assignment and overriding of `draggable` values.
 *
