 ...
 *
 * Provides a type-safe, standards-compliant set of root-level tag names for use in element rendering, widget systems,
 * and view helpers.
 *
 * Each case corresponds to a valid root-level HTML tag as defined by the W3C and MDN documentation.
 *
 * Key features:
 * - Designed for use in widget, view, and tag rendering systems requiring root element structure.
