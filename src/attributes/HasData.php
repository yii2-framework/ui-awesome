...
trait HasData
{
     ...
     *
     * Creates a new instance with the specified custom data attributes, supporting both `string` and `Closure` values
     * as required by the HTML specification for global attributes. Enforces standards-compliant key and value types,
