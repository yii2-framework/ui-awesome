...
/**
 * Trait for managing the global HTML `style` attribute in widget and tag rendering.
 *
 * Provides a standards-compliant, immutable API for setting the `style` attribute on HTML elements, following the HTML
 * specification for global attributes.
 *
 * Intended for use in widgets and components that require dynamic or programmatic manipulation of inline CSS styles,
